...
class _WebViewAuthPageState extends State<WebViewAuthPage> {
  ...
  void _initializeWebView() {
    ...
    controller
      ...
      ..addJavaScriptChannel(
        'FlutterApp',
        onMessageReceived: (JavaScriptMessage message) {
          _handleAppMessage(message.message);
        },
      )
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: WebViewConfig.showNavigationControls ? AppBar(
        ...
        floatingActionButton: WebViewConfig.showFloatingHomeButton ? FloatingActionButton(
          onPressed: () {
